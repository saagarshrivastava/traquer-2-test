...
import com.test.traquer2.domain.Region;
import com.test.traquer2.repository.RegionRepository;
...
/**
 * REST controller for managing {@link com.test.traquer2.domain.Region}.
 */
@RestController
@RequestMapping("/api")
@Transactional
